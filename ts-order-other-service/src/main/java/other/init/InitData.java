...
public class InitData implements CommandLineRunner {
    ...
    public void run(String... args)throws Exception{
        ...
        order.setId(UUID.fromString("5ad4750b-a18b-59c0-a8c0-33216b062406"));
        order.setFrom("shanghai");
        order.setTo("nanjing");
        order.setStatus(OrderStatus.PAID.getCode());
        order.setPrice("350.0");
        ...
        order.setId(UUID.fromString("5ad4750b-a18b-49c0-a8c0-333216b06279"));
        order.setAccountId(UUID.fromString("5e3b57c7-71cb-4cf1-b5bb-b68406d9da6f"));
        order.setFrom("shanghai");
        order.setTo("nanjing");
        order.setStatus(OrderStatus.PAID.getCode());
        order.setPrice("350.0");
        ...
        order.setId(UUID.fromString("5ad4750b-a18b-49c0-a8c0-331163062706"));
        order.setAccountId(UUID.fromString("5e3b57c7-71cb-4cf1-b5bb-b68406d9da6f"));
        order.setFrom("shanghai");
        order.setTo("nanjing");
        order.setStatus(OrderStatus.PAID.getCode());
        ...
        order.setId(UUID.fromString("5ad4750b-a18b-49c0-a8c0-33216b022736"));
        order.setAccountId(UUID.fromString("5e3b57c7-71cb-4cf1-b5bb-b68406d9da6f"));
        order.setFrom("shanghai");
        order.setTo("nanjing");
        order.setStatus(OrderStatus.PAID.getCode());
        ...
        order.setId(UUID.fromString("5ad4750b-a18b-49c0-a8c0-33216b062744"));
        order.setAccountId(UUID.fromString("5e3b57c7-71cb-4cf1-b5bb-b68406d9da6f"));
        order.setFrom("shanghai");
        order.setTo("nanjing");
        order.setStatus(OrderStatus.PAID.getCode());
