...
public class InitData implements CommandLineRunner {
    ...
    public void run(String... args)throws Exception{
        ...
        orderFour.setTravelDate(new Date("Sun Jul 29 00:00:00 GMT+0800 2018"));
        orderFour.setTravelTime(new Date("Mon May 04 09:00:00 GMT+0800 2013"));
        ...
        orderFour.setSeatNumber("3");
        orderFour.setFrom("shanghai");
        orderFour.setTo("nanjing");
        orderFour.setStatus(OrderStatus.PAID.getCode());
